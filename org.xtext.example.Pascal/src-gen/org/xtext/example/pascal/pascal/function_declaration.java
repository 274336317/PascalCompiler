 ...
 *   <li>{@link org.xtext.example.pascal.pascal.function_declaration#isForward <em>Forward</em>}</li>
 * </ul>
 * </p>
 *
...
public interface function_declaration extends EObject
{
   ...
   * @see org.xtext.example.pascal.pascal.PascalPackage#getfunction_declaration_Forward()
   * @model
   * @generated
   */
  boolean isForward();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.pascal.pascal.function_declaration#isForward <em>Forward</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
