...
(    this_ADDITION_OPERATOR_1=RULE_ADDITION_OPERATOR    {
...
RULE_REAL_NUMBER : (RULE_DIGIT_SEQUENCE '.' RULE_UNSIGNED_DIGIT_SEQUENCE? (('E'|'e') RULE_DIGIT_SEQUENCE)?|RULE_DIGIT_SEQUENCE ('E'|'e') RULE_DIGIT_SEQUENCE);
