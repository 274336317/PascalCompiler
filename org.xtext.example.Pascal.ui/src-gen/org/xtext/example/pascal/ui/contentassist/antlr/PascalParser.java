		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getStatementAccess().getStatementAssignment_1_0(), "rule__Statement__StatementAssignment_1_0");
					put(grammarAccess.getStatementAccess().getStatementAssignment_1_1(), "rule__Statement__StatementAssignment_1_1");
					...
					put(grammarAccess.getExpressionAccess().getOperatorAssignment_1_0_0(), "rule__Expression__OperatorAssignment_1_0_0");
					put(grammarAccess.getExpressionAccess().getOperatorAssignment_1_0_1(), "rule__Expression__OperatorAssignment_1_0_1");
					put(grammarAccess.getExpressionAccess().getOperatorAssignment_1_0_2(), "rule__Expression__OperatorAssignment_1_0_2");
					put(grammarAccess.getExpressionAccess().getExpressionsAssignment_1_1(), "rule__Expression__ExpressionsAssignment_1_1");
					put(grammarAccess.getSimple_expressionAccess().getOpteratorsAssignment_0(), "rule__Simple_expression__OpteratorsAssignment_0");
					...
					put(grammarAccess.getSimple_expressionAccess().getNumbersAssignment_2_1(), "rule__Simple_expression__NumbersAssignment_2_1");
					...
					put(grammarAccess.getNumberAccess().getNumberAssignment_0(), "rule__Number__NumberAssignment_0");
					put(grammarAccess.getNumberAccess().getNumberAssignment_1(), "rule__Number__NumberAssignment_1");
					put(grammarAccess.getUnsigned_numberAccess().getNumberAssignment_0(), "rule__Unsigned_number__NumberAssignment_0");
					put(grammarAccess.getUnsigned_numberAccess().getNumberAssignment_1(), "rule__Unsigned_number__NumberAssignment_1");
					put(grammarAccess.getSigned_numberAccess().getNumberAssignment_0(), "rule__Signed_number__NumberAssignment_0");
					put(grammarAccess.getSigned_numberAccess().getNumberAssignment_1(), "rule__Signed_number__NumberAssignment_1");
					...
					put(grammarAccess.getStructured_statementAccess().getStatementAssignment_0(), "rule__Structured_statement__StatementAssignment_0");
					put(grammarAccess.getStructured_statementAccess().getStatementAssignment_1(), "rule__Structured_statement__StatementAssignment_1");
					put(grammarAccess.getStructured_statementAccess().getStatementAssignment_2(), "rule__Structured_statement__StatementAssignment_2");
					put(grammarAccess.getStructured_statementAccess().getStatementAssignment_3(), "rule__Structured_statement__StatementAssignment_3");
					put(grammarAccess.getCompound_statementAccess().getSequenceAssignment_1(), "rule__Compound_statement__SequenceAssignment_1");
					put(grammarAccess.getRepetitive_statementAccess().getStatementAssignment_0(), "rule__Repetitive_statement__StatementAssignment_0");
					put(grammarAccess.getRepetitive_statementAccess().getStatementAssignment_1(), "rule__Repetitive_statement__StatementAssignment_1");
					put(grammarAccess.getRepetitive_statementAccess().getStatementAssignment_2(), "rule__Repetitive_statement__StatementAssignment_2");
					...
					put(grammarAccess.getConditional_statementAccess().getStatementAssignment_0(), "rule__Conditional_statement__StatementAssignment_0");
					put(grammarAccess.getConditional_statementAccess().getStatementAssignment_1(), "rule__Conditional_statement__StatementAssignment_1");
					...
					put(grammarAccess.getDeclaration_partAccess().getLabelAssignment_0(), "rule__Declaration_part__LabelAssignment_0");
					put(grammarAccess.getDeclaration_partAccess().getConstantAssignment_1(), "rule__Declaration_part__ConstantAssignment_1");
					put(grammarAccess.getDeclaration_partAccess().getTypeAssignment_2(), "rule__Declaration_part__TypeAssignment_2");
					put(grammarAccess.getDeclaration_partAccess().getVariableAssignment_3(), "rule__Declaration_part__VariableAssignment_3");
					put(grammarAccess.getDeclaration_partAccess().getProcedureAssignment_4(), "rule__Declaration_part__ProcedureAssignment_4");
					...
					put(grammarAccess.getSimple_typeAccess().getTypeAssignment_0(), "rule__Simple_type__TypeAssignment_0");
					put(grammarAccess.getSimple_typeAccess().getTypeAssignment_1(), "rule__Simple_type__TypeAssignment_1");
					...
					put(grammarAccess.getProcedure_and_function_declaration_partAccess().getDeclarationsAssignment_0_0(), "rule__Procedure_and_function_declaration_part__DeclarationsAssignment_0_0");
					put(grammarAccess.getProcedure_and_function_declaration_partAccess().getDeclarationsAssignment_0_1(), "rule__Procedure_and_function_declaration_part__DeclarationsAssignment_0_1");
					...
					put(grammarAccess.getUnpacked_conformant_array_schemaAccess().getArrayAssignment_6_0(), "rule__Unpacked_conformant_array_schema__ArrayAssignment_6_0");
					put(grammarAccess.getUnpacked_conformant_array_schemaAccess().getNameAssignment_6_1(), "rule__Unpacked_conformant_array_schema__NameAssignment_6_1");
